        ...
        if ($dataabsen == 'datapgw') {
            ...
            foreach ($query->result() as $r) {
                $data[] = [
                    ...
                    $r->npwp,
                    $r->jenis_kelamin,
                    ($r->role_id == 1) ? '<span class="badge badge-danger ml-1">Administrator</span>' : (($r->role_id == 2) ? '<span class="badge badge-primary ml-1">Moderator</span>' : (($r->role_id == 3) ? '<span class="badge badge-success ml-1">Karyawan</span>' : '<span class="badge badge-secondary ml-1">Tidak Ada Role</span>')),
                    ...
                    (($query->num_rows() > 1 && $r->role_id != 1) || $check_admin->num_rows() > 1) ?
                        ...
                        <button id="detailpegawai" class="btn btn-primary view-pegawai" data-pegawai-id="' . $r->id_pegawai . '" title="Lihat Karyawan"><span class="fas fa-fw fa-address-card"></span></button>
                        <button class="btn btn-danger delete-pegawai" title="Hapus Karyawan" data-pegawai-id="' . $r->id_pegawai . '"><span class="fas fa-trash"></span></button>
                        <button class="btn btn-warning edit-pegawai" title="Edit Karyawan" data-pegawai-id="' . $r->id_pegawai . '"><span class="fas fa-user-edit"></span></button>
                        <button class="btn btn-secondary activate-pegawai" title="Verifikasi Karyawan" data-pegawai-id="' . $r->id_pegawai . '"><span class="fas fa-user-check"></span></button>
    ...
    public function savingsettingapp()
    {
        ...
        $validation = [
            ...
            [
                ...
                'errors' => ['required' => '%s Tidak boleh kosong.', 'xss_clean' => 'Please check your form on %s.', 'max_length' => 'Nama aplikasi terlalu panjang, Max Karakter 20!']
            ],
            [
